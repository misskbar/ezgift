...
import com.example.ezgift.presentation.utils.Regex.REGEX_NON_NUMERIC_VALIDATION
...
object Regex {
    const val REGEX_NON_NUMERIC_VALIDATION = "^[a-zA-Z\\s]+"
...
fun isNameValid(name: String): Boolean {
    return Pattern.matches(REGEX_NON_NUMERIC_VALIDATION, name)
}
...
fun arePasswordsValid(password: String, confirm: String): Boolean {
    return password == confirm && confirm.isNotEmpty()
}
